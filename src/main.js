...
var $author$project$Main$Model = F5(
	function (quote, errorMsg, username, password, token) {
		return {errorMsg: errorMsg, password: password, quote: quote, token: token, username: username};
	});
...
var $author$project$Main$getQuoteNoAuth = $elm$http$Http$get(
	{
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A5($author$project$Main$Model, '', $elm$core$Maybe$Nothing, '', '', ''),
		$author$project$Main$getQuoteNoAuth);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$TokenReceived = function (a) {
	return {$: 'TokenReceived', a: a};
};
		...
		return $elm$http$Http$post(
			{
				...
				expect: A2(
					...
					$author$project$Main$TokenReceived,
...
var $author$project$Main$getQuoteAuth = function (token) {
	return $elm$http$Http$request(
		{
...
var $author$project$Main$handleHttpError = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
			var message = httpError.a;
			return $elm$core$Maybe$Just(message);
		case 'Timeout':
			return $elm$core$Maybe$Just('Server is taking too long to respond. Please try again later.');
		case 'NetworkError':
			return $elm$core$Maybe$Just('Unable to reach server.');
		case 'BadStatus':
...
var $author$project$Main$loginUserUrl = 'http://localhost:3001/sessions/create';
var $author$project$Main$registerUserUrl = 'http://localhost:3001/users';
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GetQuote':
				var _v1 = $elm$core$String$length(model.token);
				if (!_v1) {
					return _Utils_Tuple2(model, $author$project$Main$getQuoteNoAuth);
				} else {
					return _Utils_Tuple2(
						model,
						$author$project$Main$getQuoteAuth(model.token));
				}
			case 'QuoteReceived':
				if (msg.a.$ === 'Ok') {
					var result = msg.a.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMsg: $elm$core$Maybe$Just('There was an error')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'SetUsername':
			...
			case 'ClickLogin':
				return _Utils_Tuple2(
					model,
					A2($author$project$Main$authUser, model, $author$project$Main$loginUserUrl));
			case 'TokenReceived':
				if (msg.a.$ === 'Ok') {
					var result = msg.a.a;
					return _Utils_Tuple2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMsg: $author$project$Main$handleHttpError(error)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'ClickRegister':
				return _Utils_Tuple2(
					model,
					A2($author$project$Main$authUser, model, $author$project$Main$registerUserUrl));
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$ClickRegister = {$: 'ClickRegister'};
...
var $author$project$Main$getErrorText = function (maybe) {
	if (maybe.$ === 'Just') {
		var str = maybe.a;
		return str;
	} else {
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Main$getErrorText(model.errorMsg))
								]))
						])),
					A2(
					$elm$html$Html$div,
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onClick($author$project$Main$ClickRegister)
								]),
							_List_fromArray(
								[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GetQuote":[],"QuoteReceived":["Result.Result Http.Error String.String"],"SetUsername":["String.String"],"SetPassword":["String.String"],"ClickLogin":[],"ClickRegister":[],"TokenReceived":["Result.Result Http.Error String.String"],"LogOut":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));